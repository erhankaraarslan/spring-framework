...
public class MyDemoLoggingAspect {
	...
	@Around("execution(* com.karaarslan.aopdemo.service.*.getFortune(..))")
	...
	@After("execution(* com.karaarslan.aopdemo.dao.AccountDAO.findAccounts(..))")
	public void afterFinallyFindAccountsAdvice(JoinPoint thejJoinPoint) {

		String method = thejJoinPoint.getSignature().toShortString();
		myLogger.info("\n=====>>> Executing @After (finally) on method : " + method);
	}

	@AfterThrowing(pointcut = "execution(* com.karaarslan.aopdemo.dao.AccountDAO.findAccounts(..))", throwing = "theExc")
